...
import { getFirestore, collection,
         ...
         deleteDoc, doc, query,
         where, getDoc }              from 'https://www.gstatic.com/firebasejs/12.13.0/firebase-firestore.js';
...
export { db, collection, getDocs, addDoc, updateDoc, deleteDoc, doc, query, where, getDoc };
