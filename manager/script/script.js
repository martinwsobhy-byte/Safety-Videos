import { db, collection, getDocs, addDoc, updateDoc, deleteDoc, doc, query, where }
...
let editingDocId = null; // Firestore doc ID of user being edited
...
async function saveUser() {
    ...
    try {
        if (editingDocId === null) {
            ...
            await addDoc(collection(db, 'users'), { name, phone, password });
...
function renderVideos(videos) {
    ...
    // Store videos in memory for edit lookup
