...
function startUsersListener() {
    // onSnapshot بيسمع أي تغيير في collection users في realtime
        ...
        <div class="user-item">
            <div class="user-info">
                <div class="user-name-row">
                    <span class="status-dot ${u.active === 1 ? 'online' : 'offline'}"
                          title="${u.active === 1 ? 'مستخدم دلوقتي' : 'غير متصل'}"></span>
